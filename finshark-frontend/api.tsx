...
export const searchCompanies = async (request: string) => {
    try {
        const response = await axios.get<SearchResponse[]>(`https://financialmodelingprep.com/stable/search-symbol?query=${request}&apikey=${process.env.NEXT_PUBLIC_FMP_API_KEY}`);
